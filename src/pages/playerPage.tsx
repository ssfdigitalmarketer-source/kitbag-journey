        ...
        <div className="px-8 font-sans gap-20 lg:flex">
          ...
          <div className="space-y-4 flex-1 lg:text-left ">
            ...
            {player?.debuts?.map((debut,index)=>(
              <p className="text-left text-xl text-yellow-500"> {debut.title} : <span className="text-white">{debut.value}</span> </p>
            ))}
            ...
            {player?.best?.map((best,index)=>(
              <p className="text-left text-xl text-yellow-500"> {best.title} : <span className="text-white">{best.value}</span> </p>
            ))}
          </div>
        </div>

            ...
            <section className="text-center">
                ...
                <div className="py-20 space-y-8">
                    ...
                    <div className="text-xs lg:text-lg font-sans px-5 lg:w-[70%] mx-auto space-y-10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Brand & Image Positioning</h3>
                            <p>From media appearances to digital identity, we help develop an impactful personal brand.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Endorsement & Sponsorship Deals</h3>
                            <p>From media appearances to digital identity, we help develop an impactful personal brand.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Mentorship & Skill Advisory</h3>

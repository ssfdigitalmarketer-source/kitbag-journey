                ...
                <div className="py-20 space-y-8">
                    ...
                    <div className="text-lg font-sans px-5 lg:w-[70%] mx-auto space-y-10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-yellow-500 text-2xl">Creative Brand Identity</h3>
                            <p>Signature branding, campaign concepts & storytelling.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-500 text-2xl">Social Media Strategy</h3>
                            <p>Regular content planning, engagement growth & insights.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-500 text-2xl">Public Relations & Reputation Management</h3>
                            <p>Controlled brand narrative, media coordination & crisis management.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-500 text-2xl">Events & Fan Engagement</h3>

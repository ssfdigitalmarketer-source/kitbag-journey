        ...
        <div>
            <section className="">
                ...
                <div className="py-20 space-y-8">
                    {/* <h1 className="text-4xl text-yellow-400 text-center">IT SERVICES</h1> */}
                    <div className="text-xs lg:text-lg  px-5 lg:w-[70%] mx-auto space-y-10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Website Design and Development</h3>
                            <p>Creating innovative and accurate digital experiences.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Email Marketing</h3>
                            <p>Direct. Personalized. Engaging. Automated. Converting. Measurable. Effective.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">PPC</h3>
                            <p>Instant visibility, targeted advertising, measurable results.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Social Media Marketing</h3>
                            <p>Engage. Connect. Influence. Grow. Convert. Analyze. Succeed.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">SEO</h3>
                            <p>Boost visibility. Drive traffic. Rank higher.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Mobile Application Development</h3>
                            <p>Innovative solutions tailored for mobile platforms.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Corporate & Advertisement videos</h3>
                            <p>Compelling visuals that narrate brand stories effectively.</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-yellow-400 text-xl lg:text-2xl">Readymade Clone</h3>

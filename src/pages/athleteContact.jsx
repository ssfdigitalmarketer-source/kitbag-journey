    ...
    return (
        <div>
            <section className="pt-40 pb-20 space-y-8 px-5 text-xs" style={{ backgroundImage: `url('/assets/bg_paper.jpg')`, backgroundPosition: "center" }}>
                <h1 className="text-center text-4xl font-black text-yellow-400">JOIN US AS AN ATHLETE</h1>
                <p className=" text-center text-sm lg:text-lg">Submit your portfolio today and take your career to next level with our expert guidance and support.</p>

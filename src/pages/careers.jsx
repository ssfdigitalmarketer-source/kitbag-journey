...
const Careers = () => {
    ...
    return (
        <div>
            <Navbar />
            <section className="px-5 text-xs pt-40 pb-20" style={{ backgroundImage: `url('https://res.cloudinary.com/dwmmlrpgg/image/upload/v1769061372/wrinkled-paper-black-background-abstract-2026-01-09-00-09-50-utc_um1mhu.jpg')`, backgroundPosition: "center" }}>

const ContactUs = () => {
    return (
        <>
            ...
            <h2 className="font-bold text-lg text-yellow-500">OUR SOCIAL MEDIAS</h2>
            ...
            <h2 className="font-bold text-lg text-yellow-500">REACH OUT DIRECTLY</h2>
            <p className="text-lg">kitbagjourney@gmail.com</p>

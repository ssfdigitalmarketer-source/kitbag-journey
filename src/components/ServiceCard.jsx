...
const ServiceCard = ({ img, title, link}) => {
  ...
  return (
    <div className="relative shrink-0 py-20 h-[60vh] lg:h-[60vh] w-[80%] md:w-[50%] lg:w-[40%] xl:w-[20%] cursor-pointer group lg:block group will-change-transform transform-gpu backface-hidden" onClick={() => navigate(`/${link}`)}>
            ...
            <div className="w-full h-[90%] absolute top-0 left-0 overflow-hidden">
                <img
                    src={img}
                    alt="background"
                    className="w-full h-full object-cover scale-125 brightness-100 group-hover:brightness-50 group-hover:grayscale-0 transition-all duration-300 object-top"
                />

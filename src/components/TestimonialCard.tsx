...
const TestimonialCard = ({text, img, name} : any) => {
    return (
        ...
        <div className="w-full font-sans min-h-[50vh] bg-white/5 p-7 rounded-lg min-w-[280px] max-w-[320px] lg:max-w-[40%] shrink-0 space-y-8 lg:w-[30%] lg:min-h-[30vh] hover:bg-white/20 transition-all duration-300 ease-in-out">
            <div className="mx-auto flex flex-col gap-2 items-center">
                <div className='rounded-full w-14 h-auto overflow-hidden'>

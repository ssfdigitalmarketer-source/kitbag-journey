...
const TestimonialCard = ({text, img, name} : any) => {
    return (
        ...
        <div className="w-full lg:w-[50%] font-sans p-7 rounded-lg space-y-8 cursor-pointer">
            <p className='text-lg'><span className='text-yellow-500 text-xl'>" </span>{text}<span className='text-yellow-500 text-xl'> "</span></p>
            <div className="lg:flex gap-4 space-y-2 lg:space-y-0 text-center">
                <div className='rounded-full mx-auto lg:mx-0 w-20 border-[1px] border-yellow-500 h-auto overflow-hidden'>

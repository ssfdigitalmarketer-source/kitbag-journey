...
const ContactUs = () => {
    return (
        <>
            <h1 className="text-yellow-400 text-4xl text-center font-oswald">CONTACT US</h1>
            <div className="space-y-6 lg:space-y-0 lg:flex lg:gap-20">
                <div className="space-y-6 flex-1">
                    ...
                    <h2 className="font-bold text-lg text-center text-yellow-400 lg:text-left">REACH OUT DIRECTLY</h2>
                ...
                <div className="flex-1 lg:px-6">
                    <form action="">
                        <div className="space-y-4 flex flex-col font-sans">
                            ...
                            <button className="group relative overflow-hidden font-oswald px-8 py-4 mt-4 text-lg bg-yellow-400 text-black transition-transform duration-300 ease-in-out lg:w-[50%] mx-auto">

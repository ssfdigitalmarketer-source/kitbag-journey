  ...
  return (
    <section className="w-full py-20 bg-no-repeat bg-cover" >
      ...
      <div className="flex whitespace-nowrap px-8 lg:px-12 gap-10 space-x-8 my-8 lg:mx-0 scrollbar-hide overflow-x-auto cursor-grab active:cursor-grabbing" ref={ref} {...handlers}>
        <ServiceCard img='https://res.cloudinary.com/dwmmlrpgg/image/upload/v1769587805/IMG_2630.JPG_ugsuqm.jpg' title="Player Management" link={"athlete-management"}/>
        <ServiceCard img='https://res.cloudinary.com/dwmmlrpgg/image/upload/v1769506079/aksh-yadav-bY4cqxp7vos-unsplash_lx3exy.jpg' title="Cricket League Management" link={"cricket-league-management"}/>
        <ServiceCard img='https://s44783.pcdn.co/in/wp-content/uploads/sites/3/2023/03/Social-Media-Advertising.jpg.webp' title="Branding & PR" link={"branding&pr"} />

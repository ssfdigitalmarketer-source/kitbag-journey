...
const ServicesSection = () => {
  ...
  //           <ServiceCard img='/assets/services/cricket_academy_cover.webp' title="Cricket Academy" link={"cricket-academy"} />
  ...
  //   { title: "CRICKET ACADEMY", img: "/assets/services/cricket_academy_cover.webp", link: "cricket-academy" },
  ...
  return (
    <section className="w-full relative grid gap-4 lg:gap-8 lg:grid-cols-8 lg:grid-rows-4 p-5">
      ...
      <div className="relative flex items-center justify-center row-span-2 col-span-2 text-white overflow-hidden rounded-xl cursor-pointer group" onClick={() => navigate('/cricket-academy')}>
        <img src="/assets/services/cricket_academy_cover.webp" alt="" className="w-full h-full object-cover grayscale brightness-100 hover:grayscale-0 hover:brightness-75 transition-all duration-300" />
